...
tmux send-keys -t default:0.1 C-z "./main 3 6 3 1"
tmux send-keys -t default:0.2 C-z "./main 4 6 4 2"
tmux send-keys -t default:0.4 C-z "./main 5 6 4 3"
tmux send-keys -t default:0.5 C-z "./main 6 6 5 2"
tmux select-pane -t default:0.0
